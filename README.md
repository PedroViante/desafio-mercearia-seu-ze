...
Desafio proposto pelo professor Sedenilso da matéria de Design Profissional para o dia 14/09.

Carlos Eduardo Moreira
QA Pleno | Engenharia de Software
Profissional de Quality Assurance (QA), atualmente atuando como QA Pleno e cursando o 2º semestre de Engenharia de Software.

Tenho perfil analítico, proativo, resiliente, comunicativo e responsável, com foco na qualidade, identificação de problemas e melhoria contínua dos processos e produtos.

Skills
Linguagens e tecnologias: HTML, CSS, JavaScript e C
Testes e API: Cypress e Postman
